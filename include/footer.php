		...
		<div class="row g-5 mt-4">
			...
			<div class="col-lg-3 col-md-6">
				...
				<div class="position-relative mx-auto mt-3" style="max-width: 400px;">
					...
					<button type="button"
						class="btn bg_primary text-light py-2 position-absolute top-0 end-0 mt-2 me-2">SignUp</button>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="copyright">
			<div class="row">
				<div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
					&copy; <a class="text-light" href="#">2024 secondbloom.com</a>, All Right Reserved.
				</div>
