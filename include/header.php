		...
		<div class="row align-items-center top-bar">
			...
			<div class="col-lg-9 col-md-12 text-end">
				...
				<div class="h-100 d-inline-flex align-items-center">
					<a class="btn btn-sm-square bg-white text_primary me-1" href=""><i class="fab text_primary fa-facebook-f"></i></a>
					<a class="btn btn-sm-square bg-white text_primary me-1" href=""><i class="fab text_primary fa-twitter"></i></a>
					<a class="btn btn-sm-square bg-white text_primary me-1" href=""><i class="fab text_primary fa-linkedin-in"></i></a>
					<a class="btn btn-sm-square bg-white text_primary me-0" href=""><i class="fab text_primary fa-instagram"></i></a>
				</div>
			</div>
		</div>
	</div>
